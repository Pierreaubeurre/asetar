        ...
        <div class='container'>
            ...
            <form action='' method='get'>
                    <div class='input-box'>
                        ...
                        <input type='text' value='' placeholder='$data[NOM]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Nom</span>
                        <input type='text' value='' placeholder='$data[PRENOM]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Nom d'utilisateur</span>
                        <input type='text'  value='' placeholder='$data[PSEUDO_U]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Age</span>
                        <input type='text'  value='' placeholder='$data[AGE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Biographie</span>
                        <input type='text'  value='' placeholder='$data[BIO]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Code Postal</span>
                        <input type='text'  value='' placeholder='$data[CODE_POSTAL]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Centre de formation</span>
                        <input type='text'  value='' placeholder='$data[CENTRE_FORMATION]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Language *</span>
                        <input type='text'  value='' placeholder='$data[LANGUE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Date de naissance *</span>
                        <input type='date'  value='' placeholder='$data[DATE_NAISSANCE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Numéro de Téléphone *</span>
                        <input type='tel'  value='' placeholder='$data[TEL]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Adresse e-mail *</span>
                        <input type='email'  value='' placeholder='$data[MAIL]'>
                    </div>
