        ...
        <div class='container'>
            ...
            <form action='' method='post'>
                    ...
                    <div class='input-box'>
                        ...
                        <input type='text' readonly='readonly' value='$data[PRENOM]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Nom d'utilisateur</span>
                        <input type='text' readonly='readonly' value='$data[PSEUDO_U]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Age</span>
                        <input type='text' readonly='readonly' value='$data[AGE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Biographie</span>
                        <input type='text' readonly='readonly' value='$data[BIO]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Code Postal</span>
                        <input type='text' readonly='readonly' value='$data[CODE_POSTAL]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Centre de formation</span>
                        <input type='text' readonly='readonly' value='$data[CENTRE_FORMATION]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Language *</span>
                        <input type='text' readonly='readonly' value='$data[LANGUE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Date de naissance *</span>
                        <input type='date' readonly='readonly' value='$data[DATE_NAISSANCE]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Numéro de Téléphone *</span>
                        <input type='tel' readonly='readonly' value='$data[TEL]'>
                    </div>

                    <div class='input-box'>
                        <span class='details'>Adresse e-mail *</span>
                        <input type='email' readonly='readonly' value='$data[MAIL]'>
                    </div>
                    
                    <div class='input-box'>
                        <a href='./?page=modifProfil'>Modification </a>
                    </div>
